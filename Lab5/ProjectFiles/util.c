...
void fillGantInfo(THREAD_INDEX tindex, uint32_t startTick, uint32_t endTick, char charId)
{
    ...
    ganttInfo[tindex].startTick = (startTick - ticksOffset) /osKernelSysTickMicroSec(1000);
    ganttInfo[tindex].endTick = (endTick - ticksOffset )/osKernelSysTickMicroSec(1000);
